...
class UploadImageVC: BaseImageController {
    ...
    @IBAction func fuelingLocationBtnAction(_ sender: Any) {
        
        if uploadImg.image == UIImage(named: "upload"){
            Helper.Alertmessage(title: "Info:", message: "Please upload issue image", vc: self)
            
        }else if(checkButton1.isSelected == false || checkButton2.isSelected == false || checkButton3.isSelected == false){
    ...
    //MARK:- Issue Order API
    func driverIssueOrderAPI(){
        ...
        Alamofire.upload(multipartFormData: { multipartFormData in
            ...
            multipartFormData.append(imgData1, withName: "issueImage",fileName: "file.jpg", mimeType: "jpg/png/jpeg")
