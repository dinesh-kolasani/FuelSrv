...
class DriverLicenseVC: BaseImageController {
    ...
    @IBAction func nextBtnAction(_ sender: Any) {
        ...
        if imageView.image == UIImage(named: "upload"){
            Helper.Alertmessage(title: "Info:", message: "Please upload Driver License", vc: self)
            
        }else{
            
            let vc = self.storyboard?.instantiateViewController(withIdentifier: "VehicleRegistrationVC") as! VehicleRegistrationVC
            vc.img1 = imageView.image
    ...
    func navigation(){
        ...
        self.navigationItem.title = "DRIVER LICENSE"
    }
